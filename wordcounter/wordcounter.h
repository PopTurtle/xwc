...
//    depuis le flux pointé par stream. Ne prends pas en compte les erreurs du
//    flux.
...
extern int wc_file_add_filtered(wordcounter *w, FILE *stream);

//  wc_sort_count, wc_sort_lexical : tri l'ordre des mots en fonction de leur
...
//    si un tri a été effectué avant l'appel à wc_apply.
